 ...
 */
final class Version20221107232612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD date_from DATETIME DEFAULT NULL, ADD date_to DATETIME DEFAULT NULL, ADD active TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP date_from, DROP date_to, DROP active');
